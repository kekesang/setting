...
<div class="main">
  ...
  <div id="has-divider ">
      ...
      <c:forEach items="${teaList}" var="tea" varStatus="status" begin="0" end="3">
            <li class="mar-bot"> <img width="137" height="143"src="${ctxStatic}/images/img/team/mark.jpg" alt="" title="" />
              <h5>${tea.teaName}</h5>
              <h5>${tea.teaMajor}</h5>
            </li>
 </c:forEach>
