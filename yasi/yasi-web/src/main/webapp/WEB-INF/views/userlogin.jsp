...
<body>
  ...
  <tr>
    ...
    <td width="40%"><input type="text" class="box_inp1" name="account" id="account" value="请输入课程名称" onFocus="if (value =='请输入课程名称'){value =''}" onBlur="if (value ==''){value='请输入课程名称'}"/></td>
    </form>
    <td width="30%"></td>
  </tr>
  <tr>
    <td align="right">密码：</td>
    <td><input name="password" class="box_inp1" type="text" id="password"  value="请输入课程名称" onFocus="if (value =='请输入课程名称'){value =''}" onBlur="if (value ==''){value='请输入课程名称'}"/></td>
